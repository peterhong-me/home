...
//      i.e: profilePictureLink: require("../editable-stuff/personalwebsitepicture.jpg"),
...
const about = {
  show: true,
  heading: "About Me",
  imageLink: require("../editable-stuff/personalwebsitepicture.jpg"),
  imageSize: 375,
  message:
...
const leadership = {
  ...
  images: [
    { 
      img: require("../editable-stuff/personalwebsitepicture.jpg"), 
